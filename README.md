# 📊 Analyzing Chinook Database Using PostgreSQL
This repository contains a collection of SQL queries and views for analyzing the classic Chinook sample database using PostgreSQL.
